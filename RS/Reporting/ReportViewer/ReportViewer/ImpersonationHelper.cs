...
namespace Forerunner.Security
{
    ...
    {
        static int LogonType = 8;    	// LOGON32_LOGON_NETWORK_CLEARTEXT
        static int LogonProvider = 0;    // LOGON32_PROVIDER_DEFAULT
        ...
        internal static WindowsIdentity GetIdentity(string username, string domain, string password)
        {
            lock (Locker)
            {
