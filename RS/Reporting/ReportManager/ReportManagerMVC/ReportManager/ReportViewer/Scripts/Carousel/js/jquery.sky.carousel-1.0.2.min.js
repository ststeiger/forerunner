...
function(b){a.onLoad(b)});if(this.img.complete||void 0===this.img.complete||"loading"===this.img.readyState){var b=this.img.src;this.img.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";this.img.src=b}},onLoad:function(){1<this.img.height&&this.publish()}};(function(a){a.fn.carousel=function(b){var c=[];this.each(function(){var d=a(this);d.data("sky-carousel")||d.data("sky-carousel",new SKY.Carousel(d,b));c.push(d.data("sky-carousel"))});return 1<c.length?c:c[0]}})(jQuery);
...
e(a,"pfx")},h.className=h.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(" js "+r.join(" ")),f}(this,this.document);SKY.Timer=function(a,b){this.delay=a||2E3;this.repeatCount=b||0;this.currentCount=0;this.intervalID=null;this.running=!1;this.subscribers=[]};
