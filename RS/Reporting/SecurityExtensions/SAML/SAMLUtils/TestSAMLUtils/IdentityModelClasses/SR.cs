...
internal sealed class SR
{
    ...
    internal const string TraceCodeIdentityModelAsyncCallbackThrewException = "TraceCodeIdentityModelAsyncCallbackThrewException";
    ...
    internal const string TraceCodeSecurityServerSessionClosedFaultSent = "TraceCodeSecurityServerSessionClosedFaultSent";
    ...
    internal const string TraceCodeSecuritySessionClosedFaultReceived = "TraceCodeSecuritySessionClosedFaultReceived";
    internal const string TraceCodeSecuritySessionClosedFaultSendFailure = "TraceCodeSecuritySessionClosedFaultSendFailure";
