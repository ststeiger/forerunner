...
OutFile "ReportManagerSetup.exe"
...
Section "ReportManager" SEC01
  ...
  File "${LOCALROOT}\bin\ReportManager.dll"
  ...
  File "${LOCALROOT}\Forerunner\ReportExplorer\js\ReportExplorerToolbar.js"
  File "${LOCALROOT}\Forerunner\ReportExplorer\js\ReportExplorer.js"
  ...
  File "${LOCALROOT}\Forerunner\ReportViewer\js\ToolPane.js"
  File "${LOCALROOT}\Forerunner\ReportViewer\js\Toolbar.js"
  File "${LOCALROOT}\Forerunner\ReportViewer\js\ReportViewerInitializerBase.js"
  File "${LOCALROOT}\Forerunner\ReportViewer\js\ReportViewerEZ.js"
  File "${LOCALROOT}\Forerunner\ReportViewer\js\ReportViewer.js"
  File "${LOCALROOT}\Forerunner\ReportViewer\js\ReportRender.js"
  File "${LOCALROOT}\Forerunner\ReportViewer\js\ReportParameter.js"
  File "${LOCALROOT}\Forerunner\ReportViewer\js\ReportDocumentMap.js"
  File "${LOCALROOT}\Forerunner\ReportViewer\js\PageNav.js"
  ...
  File "${LOCALROOT}\Scripts\Views\ReportViewerInitializer.js"
  File "${LOCALROOT}\Scripts\Views\appPageView.js"
