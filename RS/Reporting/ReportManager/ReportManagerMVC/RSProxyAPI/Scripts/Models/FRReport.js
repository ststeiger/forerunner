...
function InitReportEx(ReportServer, ReportViewerAPI, ReportPath, Toolbar, PageNum, UID, ToolbarUID, callback) {
    var $Row =  new $("<TR/>");
    var $Cell;
...
function NavToPage(RS, NewPageNum) {
    ...
    if (RS.Lock == 0) {
        RS.Lock = 1;
        LoadPage(RS, NewPageNum, RS.Pages[RS.CurPage], false, null);
    }
