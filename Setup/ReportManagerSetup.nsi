...
Section "ReportManager" SEC01
  ...
  File "${LOCALROOT}\bin\MobilizerConfig.ps1"
  File "${LOCALROOT}\bin\Forerunner.SDK.ConfigTool.dll"
  File "${LOCALROOT}\bin\Forerunner.SDK.ConfigTool.Help.xml"
  File "${LOCALROOT}\bin\UWS.Configuration.dll"
