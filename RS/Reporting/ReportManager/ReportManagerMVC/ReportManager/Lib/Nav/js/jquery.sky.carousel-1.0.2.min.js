...
SKY.Carousel.prototype={init:function(){this.initDOM();this.initConfigParams();this.initEvents();this.initContentWrapper();this.initContainer();this.initGradientOverlays();this.initNavigationButtons();this.initResizeListener();this.initKeyboardNavigation();this.initMouseWheelSupport();this.initAutoSlideshow();this.calculateUnits();this.update();this.dom.carousel.css("visibility","visible");this.onAllLoaded()},initDOM:function(){var a=this.settings;this.dom.document=$(document);this.dom.wrapper=this.dom.carousel.children(".sky-carousel-wrapper");
...
(this.events.startEvent="touchstart.sc",this.events.moveEvent="touchmove.sc",this.events.endEvent="touchend.sc",this.events.touchCancel="touchcancel.sc"):(this.events.startEvent="mousedown.sc",this.events.moveEvent="mousemove.sc",this.events.endEvent="mouseup.sc")},initContainer:function(){var a=this,b=0;this.container=new SKY.Container(this.dom.container,this);this.dom.items.each(function(){var c=new SKY.CarouselItem($(this),a);c.subscribe("load",function(){++b;if(b==a.dom.items.length)a.onAllLoaded()});
c.load();a.carouselItems.push(c)});this.dom.carousel.on(this.events.startEvent,function(b){a.onStart(b)});SKY.Utils.hasTouchSupport()||this.dom.carousel.hover(function(){a.mouseOver=!0;a.updateCursor()},function(){a.mouseOver=!1;a.updateCursor()});this.selectedItem=this.getStartItem();this.selectedItem.addClass("sc-selected");this.updatePlugin()},initGradientOverlays:function(){var a=this.settings;if(a.gradientOverlayVisible){var b=this.createGradientOverlay("left",a.gradientStartPoint,a.gradientEndPoint,
...
d=c.getLeft(),g=[],e=0;e<this.carouselItems.length;e++){var f=this.carouselItems[e],h=d+f.x+b.itemWidth/2-this.centerX,j=Math.abs(h);if(j<=b.motionStartDistance)var n=this.calculateAlpha(j),k=this.calculateScale(j),m=this.calculateExtraDistance(j);else n=b.unselectedItemAlpha,k=b.unselectedItemZoomFactor,m=0;j<=this.centerX&&(f.setDistance(j),g.push(f));f.setAlpha(n);f.setScale(k);0<h?f.setX(f.getBaseOffset()+2*b.selectedItemDistance-m):f.setX(f.getBaseOffset()+m);h=j=n=k=m=null}this.zSort(g);this.dragging&&
...
function(){b.element.off("webkitTransitionEnd transitionend oTransitionEnd otransitionend MSTransitionEnd");b.carousel.onSelectionAnimationEnd()}),SKY.Utils.hasTransitionSupport()?(this.element.css(SKY.Utils.getPrefixedProperty("transition"),"left "+a+"s ease-out"),this.element.css("left",this.x)):this.element.stop().animate({left:this.x},1E3*a,function(){b.carousel.onSelectionAnimationEnd()})):(SKY.Utils.hasTransitionSupport()&&this.element.css(SKY.Utils.getPrefixedProperty("transition"),""),this.element.stop().css({left:this.x}))}};
SKY.ImageLoader=function(a){this.subscribers=[];this.img=a;this.fired=!1};
...
(clearInterval(this.intervalID),this.running=!1)},tick:function(){++this.currentCount;this.publish("timer");this.currentCount==this.repeatCount&&(this.reset(),this.stop(),this.publish("timercomplete"))}};
SKY.Utils={touchSupport:null,canvasSupport:null,transformation2dSupport:null,transformation3dSupport:null,transitionSupport:null,prefixedProps:[],hasTouchSupport:function(){null===this.touchSupport&&(this.touchSupport=Modernizr.touch);return this.touchSupport},hasCanvasSupport:function(){null===this.canvasSupport&&(this.canvasSupport=Modernizr.canvas);return this.canvasSupport},has2dTransformationSupport:function(){null===this.transformation2dSupport&&(this.transformation2dSupport=Modernizr.csstransforms);
return this.transformation2dSupport},has3dTransformationSupport:function(){null===this.transformation3dSupport&&(this.transformation3dSupport=Modernizr.csstransforms3d);return this.transformation3dSupport},hasTransitionSupport:function(){null===this.transitionSupport&&(this.transitionSupport=Modernizr.csstransitions);return this.transitionSupport},getPrefixedProperty:function(a){void 0===this.prefixedProps[a]&&(this.prefixedProps[a]=Modernizr.prefixed(a));return this.prefixedProps[a]},setCursor:function(a){switch(a){case "openhand":$("body").removeClass("sc-closedhand");
$("body").addClass("sc-openhand");break;case "closedhand":$("body").removeClass("sc-openhand");$("body").addClass("sc-closedhand");break;default:$("body").removeClass("sc-openhand"),$("body").removeClass("sc-closedhand")}},hexToRGB:function(a){"#"===a[0]&&(a=a.substr(1));if(3==a.length){var b=/^([a-f\d])([a-f\d])([a-f\d])$/i.exec(a).slice(1);a="";for(var c=0;3>c;c++)a+=b[c]+b[c]}b=/^([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a).slice(1);return{r:parseInt(b[0],16),g:parseInt(b[1],16),b:parseInt(b[2],
16)}}};window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)}}();(function(a){a.fn.carousel=function(b){var c=[];this.each(function(){var d=a(this);d.data("sky-carousel")||d.data("sky-carousel",new SKY.Carousel(d,b));c.push(d.data("sky-carousel"))});return 1<c.length?c:c[0]}})(jQuery);
window.Modernizr=function(a,b,c){function d(a,b){return typeof a===b}function g(a,b){for(var d in a){var f=a[d];if(!~(""+f).indexOf("-")&&n[f]!==c)return"pfx"==b?f:!0}return!1}function e(a,b,f){var e=a.charAt(0).toUpperCase()+a.slice(1),h=(a+" "+m.join(e+" ")+e).split(" ");if(d(b,"string")||d(b,"undefined"))b=g(h,b);else{h=(a+" "+l.join(e+" ")+e).split(" ");a:{a=h;for(var j in a)if(e=b[a[j]],e!==c){b=!1===f?a[j]:d(e,"function")?e.bind(f||b):e;break a}b=!1}}return b}var f={},h=b.documentElement,j=
b.createElement("modernizr"),n=j.style,k=" -webkit- -moz- -o- -ms- ".split(" "),m=["Webkit","Moz","O","ms"],l=["webkit","moz","o","ms"],j={},r=[],p=r.slice,t,v=function(a,c,d,e){var f,g,j,n,k=b.createElement("div"),m=b.body,l=m||b.createElement("body");if(parseInt(d,10))for(;d--;)j=b.createElement("div"),j.id=e?e[d]:"modernizr"+(d+1),k.appendChild(j);return f=['&#173;<style id="smodernizr">',a,"</style>"].join(""),k.id="modernizr",(m?k:l).innerHTML+=f,l.appendChild(k),m||(l.style.background="",l.style.overflow=
"hidden",n=h.style.overflow,h.style.overflow="hidden",h.appendChild(l)),g=c(k,a),m?k.parentNode.removeChild(k):(l.parentNode.removeChild(l),h.style.overflow=n),!!g},w={}.hasOwnProperty,u;!d(w,"undefined")&&!d(w.call,"undefined")?u=function(a,b){return w.call(a,b)}:u=function(a,b){return b in a&&d(a.constructor.prototype[b],"undefined")};Function.prototype.bind||(Function.prototype.bind=function(a){var b=this;if("function"!=typeof b)throw new TypeError;var c=p.call(arguments,1),d=function(){if(this instanceof
d){var e=function(){};e.prototype=b.prototype;var e=new e,f=b.apply(e,c.concat(p.call(arguments)));return Object(f)===f?f:e}return b.apply(a,c.concat(p.call(arguments)))};return d});j.canvas=function(){var a=b.createElement("canvas");return!!a.getContext&&!!a.getContext("2d")};j.canvastext=function(){return!!f.canvas&&!!d(b.createElement("canvas").getContext("2d").fillText,"function")};j.touch=function(){var c;return"ontouchstart"in a||a.DocumentTouch&&b instanceof DocumentTouch?c=!0:v(["@media (",
k.join("touch-enabled),("),"modernizr){#modernizr{top:9px;position:absolute}}"].join(""),function(a){c=9===a.offsetTop}),c};j.cssanimations=function(){return e("animationName")};j.csstransforms=function(){return!!e("transform")};j.csstransforms3d=function(){var a=!!e("perspective");return a&&"webkitPerspective"in h.style&&v("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}",function(b){a=9===b.offsetLeft&&3===b.offsetHeight}),a};j.csstransitions=function(){return e("transition")};
for(var x in j)u(j,x)&&(t=x.toLowerCase(),f[t]=j[x](),r.push((f[t]?"":"no-")+t));f.addTest=function(a,b){if("object"==typeof a)for(var d in a)u(a,d)&&f.addTest(d,a[d]);else{a=a.toLowerCase();if(f[a]!==c)return f;b="function"==typeof b?b():b;h.className+=" "+(b?"":"no-")+a;f[a]=b}return f};n.cssText="";return j=null,f._version="2.6.2",f._prefixes=k,f._domPrefixes=l,f._cssomPrefixes=m,f.testProp=function(a){return g([a])},f.testAllProps=e,f.testStyles=v,f.prefixed=function(a,b,c){return b?e(a,b,c):
e(a,"pfx")},h.className=h.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(" js "+r.join(" ")),f}(this,this.document);