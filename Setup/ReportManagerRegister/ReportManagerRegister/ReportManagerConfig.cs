...
namespace ReportManagerRegister
{
    public static class ReportManagerConfig
    {
        ...
        public static void UpdateWebConfig(string physicalPath, string wsurl, string testaccountdomain, string testaccount,
            string testaccountpwd, string reportserverdatasource, string reportserverdb, string reportserverdbuser, string reportserverdbpwd)
        {
            ...
            GetConfigNode(doc, "Forerunner.TestAccountDomain").UpdateValue(testaccountdomain);

            GetConfigNode(doc, "Forerunner.TestAccount").UpdateValue(testaccount);

            GetConfigNode(doc, "Forerunner.TestAccountPWD").UpdateValue(testaccountpwd);
